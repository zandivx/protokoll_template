...
\ihead{Versuch: \\ Versuchsname}  % Kopf links (inner)
\chead{\textsc{Nachname1} Vorname1 \\ \textsc{Nachname2} Vorname2}  % Kopf mittig (center)
\ohead{Datum: \\ Datum der Messung}  % Kopf rechts (outer)
