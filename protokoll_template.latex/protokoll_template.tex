...
\usepackage[hidelinks]{hyperref}  % als letztes laden, sorgt für die meisten Fehler

% Literaturverwaltung
\usepackage[style=apa]{biblatex}  % backend=biber is standard
\usepackage{csquotes}  % warning - should be used in combination with package babel
...
\chead{\textsc{Zach} Andreas}  % Kopf mittig (center)
...
\sisetup{locale = DE}
% biblatex source
\addbibresource{C:/Users/andre/Dropbox/Uni/Physik/Allgemeines/JabRef_Database/physics.bib}  % database import with absolute path - .bib!
