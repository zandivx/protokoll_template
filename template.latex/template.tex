...
% BibLaTeX source
\addbibresource{C:/Users/andre/OneDrive - Universität Graz/Uni/Physik/Allgemeines/protokoll_template/files/JabRef_Database/physics.bib}  % database import with absolute path - file ending!
...
% }
\input{C:/Users/andre/OneDrive - Universität Graz/Uni/Physik/Allgemeines/protokoll_template/files/environments/tabularray-environments.tex}
...
\begin{equation}
    ...
    \int \limits_{a}^{b} x^2 \dd{x} =\frac{b^3-a^3}{3}  % \, -> small space, single character exponent doesn't need curly braces
\end{equation}
%
% inline math
