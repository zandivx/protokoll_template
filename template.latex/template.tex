...
\UseTblrLibrary{diagbox}  % diagonal boxes in tables (import suited for tabularray)
...
\begin{equation}
    ...
    \int \limits_{a}^{b} x^2 \, dx =\frac{b^3-a^3}{3}  % \, -> small space, single character exponent doesn't need curly braces
\end{equation}
%
% inline math
