...
\UseTblrLibrary{siunitx}  % S column for tabularray - TRIPLE BRACKETS!! {{{}}} - separate load for options needed
        ...
        \begin{tblr}{
                colspec={
                        *{3}{Q}  % multiplication syntax: *{n}{thing}
                        S[table-format=2.2]
                        Q  % Q column for not overwriting standard values of preamble
                    },
            ...
            Gerät 3 & -          & passt so &                       & --//--                              \\
            Gerät 4 & -          &          &                       & \diagbox[dir=NE, width=182pt]{a}{b} \\  % if diagbox is not the widest column, width must be typeset manually -.-
        \end{tblr}
    \end{samepage}
\end{table}
